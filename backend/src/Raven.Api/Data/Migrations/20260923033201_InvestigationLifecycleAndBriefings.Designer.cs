...
namespace Raven.Api.Data.Migrations
{
    ...
    [Migration("20260923033201_InvestigationLifecycleAndBriefings")]
    partial class InvestigationLifecycleAndBriefings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Raven.Api.Features.Chat.ChatCitation", b =>
                {
                    ...
                    b.ToTable("ChatCitations", t =>
                        {
                            t.HasCheckConstraint("CK_ChatCitations_ExactlyOneEvidence", "(\"SourceDocumentId\" IS NOT NULL AND \"WebEvidenceSnapshotId\" IS NULL) OR (\"SourceDocumentId\" IS NULL AND \"WebEvidenceSnapshotId\" IS NOT NULL)");
                        });
                });
