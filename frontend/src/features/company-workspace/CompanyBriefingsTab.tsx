...
export function CompanyBriefingsTab({ companyId, initialInvestigationId, initialBriefingId, initialBriefingVersionNumber, onSeedConsumed, onDeepResearch, onExternalResearch }: Props) {
